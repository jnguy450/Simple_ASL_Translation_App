...
Abstract:
A `Landmark` is the name and location of a point on a human hand, including:
 - Left shoulder
 - Right eye
 - Nose
*/
...
extension Pose {
    ...
    /// The name and location of a point of interest on a human hand.
    ///
    /// Each landmark defines its location in an image and the name of the hand
    /// joint it represents.
    struct Landmark {
        ...
        /// - Parameter point: A point in a human hand pose observation.
