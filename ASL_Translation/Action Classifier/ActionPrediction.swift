...
struct ActionPrediction {
    /// The name of the action the Gesture Classifier predicted.
    let label: String

    /// The Gesture Classifier's confidence in its prediction.
...
extension ActionPrediction {
    ...
    static let noPersonPrediction = ActionPrediction(.noHand)
